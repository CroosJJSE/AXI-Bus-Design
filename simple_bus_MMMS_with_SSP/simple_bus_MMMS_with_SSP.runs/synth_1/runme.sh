...
HD_PWD='C:/Users/Public/AXI_Bus_Design/simple_bus_MMMS_with_SSP/simple_bus_MMMS_with_SSP.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_simple_bus_MMMS_SSS.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tb_simple_bus_MMMS_SSS.tcl
