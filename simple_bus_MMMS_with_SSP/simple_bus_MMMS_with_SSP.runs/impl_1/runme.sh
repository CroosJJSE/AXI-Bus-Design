...
HD_PWD='C:/Users/Public/AXI_Bus_Design/simple_bus_MMMS_with_SSP/simple_bus_MMMS_with_SSP.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log tb_simple_bus_MMMS_SSS.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source tb_simple_bus_MMMS_SSS.tcl -notrace
